    ...
    <>
      <div className="legal">
        ...
        <p>
          ...
          <br />
          <strong>Responsable publication</strong> : Rianne STREEF –
          rianne@vts-webdesign.com
          <br />
          Le responsable publication est une personne physique ou une personne
          morale.
          <br />
          <strong>Webmaster</strong> : Rianne STREEF – rianne@vts-webdesign.com
          <br />
          <strong>Hébergeur</strong> : OVH – 77 Boulevard Marius Vivier Merle,
          69003 Lyon
        </p>
        ...
        <p>
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> implique
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> sont donc
        ...
        <p>
          ...
          est mis à jour régulièrement par Rianne STREEF. De la même façon, les
        ...
        <p>
          Le site <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> a
        ...
        <p>
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site{" "}
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> ne sont
        ...
        <p>
          A l&lsquo;occasion de l&lsquo;utilisation du site{" "}
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a>, peuvent
          êtres recueillies : l&lsquo;URL des liens par l&lsquo;intermédiaire
          desquels l&lsquo;utilisateur a accédé au site{" "}
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a>, le
          fournisseur d&lsquo;accès de l&lsquo;utilisateur, l&lsquo;adresse de
          protocole Internet (IP) de l&lsquo;utilisateur.
        </p>
        <p>
          {" "}
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a>.
          L&lsquo;utilisateur fournit ces informations en toute connaissance de
          cause, notamment lorsqu&lsquo;il procède par lui-même à leur saisie.
          Il est alors précisé à l&lsquo;utilisateur du site{" "}
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a>{" "}
        ...
        <p>
          Aucune information personnelle de l&lsquo;utilisateur du site{" "}
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a>{" "}
        ...
        <p>
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> est
        ...
        <p>
          ...
          bouton Firefox, puis aller dans l&lsquo;onglet Options. Cliquer sur
          l&lsquo;onglet Vie privée. Paramétrez les Règles de conservation sur :
          utiliser les paramètres personnalisés pour l&lsquo;historique. Enfin
        ...
        <p>
          ...
          section &lsquo;Confidentialité&lsquo;, cliquez sur Paramètres de
          contenu. Dans la section &lsquo;Cookies&lsquo;, vous pouvez bloquer
          les cookies.
        </p>
        <p>
          ...
          Dans la section &lsquo;Confidentialité&lsquo;, cliquez sur
          préférences. Dans l&apos;onglet &lsquo;Confidentialité&lsquo;, vous
        ...
        <p>
          ...
          <a href={intakeInfo.domainName}>{intakeInfo.domainName}</a> est soumis
          au droit français. Il est fait attribution exclusive de juridiction
